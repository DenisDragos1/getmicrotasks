...
<Navbar onToggleSidebar={toggleSidebar} />
      <nav
        id="sidenav-8"
        className={`absolute left-0 top-0 z-[1035] h-full w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] ${
